...
class TeacherPostG extends Teacher {
  ...
  public function __construct($id, $name, $email, $special_needs, $document_number, $document_emissor, $document_uf, $phone, $cpf, $created_at, $address, $file_path, $disciplines = [], $educations = [], $activities = [], $lectures = [], $enabled, $post_graduation) {
