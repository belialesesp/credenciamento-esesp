<?php
// =================================================================
// backend/api/export_interpreters_pdf.php - WITHOUT CPF/PHONE
// =================================================================
...
try {
    ...
    foreach ($interpreters as $interp) {
        ...
        $pdf->Cell(70, 7, substr($interp['name'], 0, 40), 1, 0, 'L');
        $pdf->Cell(60, 7, substr(strtolower($interp['email']), 0, 35), 1, 0, 'L');
        $pdf->Cell(35, 7, $dateF, 1, 0, 'C');
        $pdf->Cell(35, 7, $calledF, 1, 0, 'C');
        $pdf->Cell(40, 7, substr($interp['scholarship'] ?? 'N/A', 0, 25), 1, 0, 'L');
